        ...
        <div class="xl:flex">
            <div class="xl:w-3/4 2xl:w-4/5 -mt-8 xl:-mt-44">
                <div class="px-4 md:px-10 py-4 md:py-7 bg-gray-100 rounded-tl-lg rounded-tr-lg shadow lg:flex justify-between items-center">
                    <p class="text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">Customer</p>
                            ...
                            <table class="w-full whitespace-nowrap">
                                <thead>
                                    <tr class="h-20 w-full text-sm leading-none text-gray-600">
                                        ...
                                        <th class="font-normal text-left">Actions</th>
                                    </tr>
                                </thead>
                                <tbody class="w-full">
                                    @foreach($customers as $customer)
                                    <tr class="table-row">
                                        <td class="pl-11">{{ $customer->name }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="bg-gray-100 mr-3 hover:bg-gray-200 py-2.5 px-5 rounded text-sm leading-3 text-gray-500" @click="console.log(true)">Edit</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
